  ...
  return (
    <Box flexGrow={1} width="100%">
      <Routes>
        ...
        <Route path="/nuclear/availability" element={<Availability />} />
        ...
        <Route path="/renewableenergy/solarenergy" element={<SolarEnergy />} />
        <Route path="/renewableenergy/windenergy" element={<WindEnergy />} />
        <Route
        ...
        <Route
          ...
          element={<BioEnergy />}
        />
        <Route path="/renewableenergy/oceanenergy" element={<OceanEnergy />} />
