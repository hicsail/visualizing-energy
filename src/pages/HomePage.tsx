  ...
  return (
    <Layout title={null}>
      <Flex direction="column" alignItems="center">
        ...
        <Flex bgColor="#D3D3D3" width="100%" justifyContent="center" p="12px">
        ...
        <Flex p="20px" justifyContent="space-between" gap="20px" width="100%">
          <Box bg="#D3D3D3" width="100%">
            <Image src="https://picsum.photos/300/300" objectFit="cover" />
