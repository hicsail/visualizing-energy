                    ...
                    onResizeStop={(e) => {
                      ...
                      try {
                        Transforms.setNodes(
                          editor,
                          {
                            height: rightRef.current.state.height,
                            width: rightRef.current.state.width,
                          },
                          { at: path }
                        );
                      } catch (e) {
          ...
          >
            {writeKey ? (
              <ResizableBox
                ...
                onResizeStart={() => setResizeInProgress(true)}
                onResizeStop={(e) => {
                  setiFrameHeight(ElementRef.current.state.height);
                  setiFrameWidth(ElementRef.current.state.width);
                  console.log(iFrameHeight, iFrameWidth);
                  setResizeInProgress(false);
                  // try {
                  //     setiFrameHeight(
        ...
        <div>
          ...
          {textOnLeft ? (
            <Box display="flex" alignItems="center " height="100%">
              <Box width={sliderValue.toString() + "%"} height="100%">
                {/* <PlainText /> */}
                <Box height="100%">
                  <RichText
                    storageId={"storage"}
                  ...
                  <Box>
                    {writeKey ? (
                      <ResizableBox
                        ...
                        onResizeStart={() => setResizeInProgress(true)}
                        onResizeStop={(e) => {
                          setiFrameHeight(leftRef.current.state.height);
                          setiFrameWidth(leftRef.current.state.width);
                          console.log(iFrameHeight, iFrameWidth);
                          setResizeInProgress(false);
                        }}
                      >
                ...
                >
                  {writeKey ? (
                    <ResizableBox
                      ...
                      onResizeStart={() => setResizeInProgress(true)}
                      onResizeStop={(e) => {
                        setiFrameHeight(rightRef.current.state.height);
                        setiFrameWidth(rightRef.current.state.width);
                        console.log(iFrameHeight, iFrameWidth);
                        setResizeInProgress(false);
                      }}
                    >
